    ...
    <StyledHomePage>
      <StyledHeader ref={heroRef}>
        ...
        <StyledMobileMenu open={menuOpen}>
          <StyledNavItem href="#">Start</StyledNavItem>
          <StyledNavItem href="#">Våra tjänster</StyledNavItem>
          <StyledNavItem href="#">Anskaffning</StyledNavItem>
          <StyledNavItem href="#">Kontakta oss</StyledNavItem>
          <StyledNavItem href="#">Logga in</StyledNavItem>
